...
from app.thread.capture_thread import CaptureThread
from app.thread.command_thread import CommandThread
...
class PlayerInterface(ScrollArea):
    ...
    def addDeviceComboItem(self, device_info: DeviceInfo):
        self.comboBox.addItem(
            text=device_info.name + "(" + device_info.ip + ")", userData=device_info.ip
        )
