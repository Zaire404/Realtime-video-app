...
from app.components.device_card import DeviceCardView
...
class DeviceInterface(ScrollArea):
    ...
    def __initSlot(self):
        self.addDeviceCardSignal.connect(
            lambda device_info: self.deviceCardView.addDeviceCard(device_info)
        )
